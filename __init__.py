...
from .sub_modules import NHiTS as NHiTSModule
...
#         print("*******IMPORTANCE*****")
        ...
        self.model = NHiTSModule(
            ...
            hidden_size=self.n_stacks * [2 * [self.hparams.hidden_size]], # 这里写死了n_layers=2，若n_layers不等于2，可能会报错
...
#     def customer_encoder_covariate_size(self) -> int:
#         """Covariate size.

#         Returns:
#             int: size of time-dependent covariates of encoder
#         """
#         print("*********Output of customer_encoder_covariate_size**************")
#         print(len(set(self.hparams.time_varying_reals_encoder)))
#         print(len(set(self.target_names)))
...
#     def customer_decoder_covariate_size(self) -> int:
#         """Covariate size.

#         Returns:
#             int: size of time-dependent covariates of decoder
#         """
#         return len(set(self.hparams.time_varying_reals_decoder) - set(self.target_names)) + sum(
#             self.embeddings.output_size[name] for name in self.hparams.time_varying_categoricals_decoder
#         )
